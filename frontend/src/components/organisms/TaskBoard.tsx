...
const columns: Array<{
...
}> = [
  {
    ...
    status: "inbox",
    dot: "bg-slate-400",
    accent: "hover:border-slate-400 hover:bg-[color:var(--surface-muted)]",
    text: "group-hover:text-strong text-muted",
    badge: "bg-[color:var(--surface-strong)] text-muted",
  },
  {
    title: "In Progress",
    status: "in_progress",
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        reviewBucket === option.key
                          ...
                          : "border-[color:var(--border)] bg-[color:var(--surface)] text-muted hover:border-slate-300 hover:bg-[color:var(--surface-muted)]",
                      )}
