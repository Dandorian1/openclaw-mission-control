  ...
  return (
    <div className="relative">
      <Select value={orgValue} onValueChange={handleOrgChange}>
        ...
        <SelectContent className="min-w-[220px] rounded-md border-[color:var(--border)] p-1 shadow-xl">
          ...
          {orgs.length ? (
            orgs.map((org) => (
              <SelectItem
                key={org.id}
                value={org.id}
                className="rounded-md py-2 pl-7 pr-3 text-sm text-strong data-[state=checked]:bg-[color:var(--surface-muted)] data-[state=checked]:text-strong focus:bg-[color:var(--surface-strong)]"
              >
                {org.name}
              </SelectItem>
            ))
            ...
            <SelectItem
              value={orgValue}
              className="rounded-md py-2 pl-7 pr-3 text-sm text-strong"
            >
              Organization
            </SelectItem>
          )}
