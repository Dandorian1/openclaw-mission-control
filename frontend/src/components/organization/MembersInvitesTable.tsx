    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-200 text-xs font-semibold text-muted">
      ...
      },
      {
        ...
        cell: ({ row }) => {
          if (row.original.kind === "member") {
            ...
            if (!isAdmin) {
              return <span className="text-xs text-quiet">Admin only</span>;
            }
            return (
