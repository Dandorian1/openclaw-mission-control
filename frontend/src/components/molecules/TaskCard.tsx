...
export function TaskCard({
  ...
  return (
    <div
      className={cn(
        "group relative cursor-pointer rounded-lg border border-[color:var(--border)] bg-[color:var(--surface)] p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md",
        ...
        <div className="flex flex-shrink-0 flex-col items-end gap-2">
          <span
            className={cn(
              ...
              priorityBadge(priority) ?? "bg-[color:var(--surface-strong)] text-muted",
            )}
          >
            {priorityLabel}
          </span>
