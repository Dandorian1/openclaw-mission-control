...
const baseTriggerClassName =
  "w-auto h-auto rounded-xl border-2 border-gray-200 bg-[color:var(--surface)] px-4 py-3 text-left text-sm font-semibold text-gray-700 shadow-sm transition-all duration-200 hover:border-gray-300 focus:border-gray-900 focus:ring-4 focus:ring-gray-100";
const baseContentClassName =
  "rounded-xl border-2 border-gray-200 bg-[color:var(--surface)] shadow-xl";
