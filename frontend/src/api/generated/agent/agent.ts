 ...
 */
export type listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponse200 =
  {
    data: TaskAttachmentRead[];
    status: 200;
  };

export type listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponse422 =
  {
    data: HTTPValidationError;
    status: 422;
  };

export type listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponseSuccess =
  listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponse200 & {
    headers: Headers;
  };
export type listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponseError =
  listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponse422 & {
    headers: Headers;
  };

export type listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponse =

    | listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponseSuccess
    | listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponseError;

export const getListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetUrl =
  (boardId: string, taskId: string) => {
    return `/api/v1/agent/boards/${boardId}/tasks/${taskId}/attachments`;
  };

export const listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGet =
  async (
    boardId: string,
    taskId: string,
    options?: RequestInit,
  ): Promise<listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponse> => {
    return customFetch<listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetResponse>(
      getListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetUrl(
        boardId,
        taskId,
      ),
      {
...
export const getListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetQueryKey =
  (boardId: string, taskId: string) => {
    return [
      `/api/v1/agent/boards/${boardId}/tasks/${taskId}/attachments`,
    ] as const;
  };

export const getListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetQueryOptions =
  <
    TData = Awaited<
      ReturnType<
        typeof listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGet
      >
    >,
    TError = HTTPValidationError,
  >(
    ...
    const queryKey =
      queryOptions?.queryKey ??
      getListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetQueryKey(
        boardId,
        taskId,
      );
    ...
    const queryFn: QueryFunction<
      ...
      >
    > = ({ signal }) =>
      listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGet(
        boardId,
        taskId,
        { signal, ...requestOptions },
      );
...
export type ListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetQueryResult =
  NonNullable<
    Awaited<
      ReturnType<
        typeof listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGet
    ...
    >
  >;
export type ListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetQueryError =
  HTTPValidationError;

export function useListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGet<
  TData = Awaited<
    ReturnType<
      typeof listTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGet
    >
...
>(
  ...
  const queryOptions =
    getListTaskAttachmentsApiV1AgentBoardsBoardIdTasksTaskIdAttachmentsGetQueryOptions(
      boardId,
      taskId,
      options,
    );
