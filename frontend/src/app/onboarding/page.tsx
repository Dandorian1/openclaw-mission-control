              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-strong flex items-center gap-2">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 rounded-md border border-slate-300 px-4 py-2.5 text-sm font-medium text-strong transition-colors hover:bg-[color:var(--surface-muted)]"
                  >
