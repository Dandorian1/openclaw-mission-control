...
from app.api.task_notifications import (
    notify_agent_on_task_assign as _notify_agent_on_task_assign,
    notify_agent_on_task_rework as _notify_agent_on_task_rework,
    notify_lead_on_task_create as _notify_lead_on_task_create,
    notify_lead_on_task_unassigned as _notify_lead_on_task_unassigned,
    wake_agent_online_for_task as _wake_agent_online_for_task,
    send_agent_task_message as _send_agent_task_message,
    send_lead_task_message as _send_lead_task_message,
    assignment_notification_message as _assignment_notification_message,
    rework_notification_message as _rework_notification_message,
    latest_task_comment_by_agent as _latest_task_comment_by_agent,
    notify_agent_on_task_assign,
)
from app.api.task_comments_attachments import (
    router as comments_attachments_router,
    list_task_comments,
    create_task_comment,
    ...
    validate_task_comment_access as _validate_task_comment_access,
    comment_actor_id as _comment_actor_id,
    comment_targets as _comment_targets,
    notify_task_comment_targets as _notify_task_comment_targets,
    TaskCommentNotifyRequest as _TaskCommentNotifyRequest,
)
from app.api.task_queries import (
    BoardCustomFieldDefinition as _BoardCustomFieldDefinition,
    parse_since as _parse_since,
    coerce_task_items as _coerce_task_items,
    coerce_task_event_rows as _coerce_task_event_rows,
    status_values as _status_values,
    serialize_comment as _serialize_comment,
    fetch_task_events as _fetch_task_events,
    organization_custom_field_definitions_for_board as _organization_custom_field_definitions_for_board,
    task_custom_field_values_by_task_id as _task_custom_field_values_by_task_id,
    task_dep_ids as _task_dep_ids,
    task_blocked_ids as _task_blocked_ids,
    task_assignment_agent_ids as _task_assignment_agent_ids,
    task_assignments_by_task_id as _task_assignments_by_task_id,
    task_read_page as _task_read_page,
    task_read_response as _task_read_response,
    stream_task_state as _stream_task_state,
    task_list_statement as _task_list_statement,
    ALLOWED_STATUSES,
    TASK_EVENT_TYPES,
    TASK_EVENT_ROW_LEN,
)
...
router.include_router(comments_attachments_router)
...
async def _lead_apply_status(
    ...
    *,
    ...
    # Also supports the assignment-and-start shortcut from upstream.
