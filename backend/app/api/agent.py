...
from app.api.agent_permissions import (
    ...
    guard_lead_cross_board_access as _guard_lead_cross_board_access,
    require_board_lead as _require_board_lead,
    guard_task_access as _guard_task_access,
    is_agent_assigned_to_task as _is_agent_assigned_to_task,
    guard_task_comment_access_with_assignment as _guard_task_comment_access_with_assignment,
    guard_task_update_cross_board as _guard_task_update_cross_board,
    guard_task_read_access as _guard_task_read_access,
    require_board_not_paused as _require_board_not_paused,
)
...
from app.api.agent_messaging import router as messaging_router
